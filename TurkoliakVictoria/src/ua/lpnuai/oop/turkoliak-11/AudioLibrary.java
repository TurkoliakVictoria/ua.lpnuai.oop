...
public class AudioLibrary implements Serializable {
    ...
    public AudioLibrary(String name, String genre, String author,String actors, String text, String date, String duration,
                        String dataFormat) {
        this.name = name;
        this.genre = genre;
        this.author = author;
    ...
    public AudioLibrary autoinit(AudioLibrary object) throws IOException {
